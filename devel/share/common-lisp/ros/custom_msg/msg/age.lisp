...
(cl:defmethod cl:initialize-instance :after ((m <age>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'age)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msg-msg:<age> is deprecated: use custom_msg-msg:age instead.")))

(cl:ensure-generic-function 'years-val :lambda-list '(m))
(cl:defmethod years-val ((m <age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg-msg:years-val is deprecated.  Use custom_msg-msg:years instead.")
  (years m))

(cl:ensure-generic-function 'months-val :lambda-list '(m))
(cl:defmethod months-val ((m <age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg-msg:months-val is deprecated.  Use custom_msg-msg:months instead.")
  (months m))

(cl:ensure-generic-function 'days-val :lambda-list '(m))
(cl:defmethod days-val ((m <age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_msg-msg:days-val is deprecated.  Use custom_msg-msg:days instead.")
  (days m))
